...
namespace XMPP
{
	...
	public:
		...
		void startDialbackVerifyOut(const QString &to, const QString &from);
		...
		void sendDialbackResultRequest(const Jid &to, const Jid &from, const QString &key);
		void sendDialbackResultGrant(const Jid &to, const Jid &from, bool ok);
		void sendDialbackVerifyRequest(const Jid &to, const Jid &from, const QString &id, const QString &key);
		void sendDialbackVerifyGrant(const Jid &to, const Jid &from, const QString &id, bool ok);

		// input
		QString user, host, resource;
		Jid clientJid;
