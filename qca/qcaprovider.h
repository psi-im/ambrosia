...
public:
	...
	virtual void reset()=0;
	virtual bool startClient(const QList<QCA_CertContext*> &store, const QCA_CertContext &cert, const QCA_RSAKeyContext &key)=0;
	virtual bool startServer(const QList<QCA_CertContext*> &store, const QCA_CertContext &cert, const QCA_RSAKeyContext &key)=0;
